...
//     {
//         public async static Task	ShowEventsAsync(IHttpClientFactory httpClient, Message message, TelegramBotClient client, DataContext context, int pageSize)
// 		{
...
// 			}
// 		}
//         public async static Task	FavouritesAsync(Message message, TelegramBotClient client, DataContext context)
// 		{
...
// 		}
//         public async static Task	ShowFilmsAsync(IHttpClientFactory httpClient, Message message, TelegramBotClient client, DataContext context, int pageSize)
// 		{
// 			var user = await context.Users.FirstOrDefaultAsync(u => u.ChatId == message.Chat.Id);
...
// 		}
//         public async static Task	ShowPlacesAsync(IHttpClientFactory httpClient, Message message, TelegramBotClient client, DataContext context, int pageSize)
// 		{
// 			var user = await context.Users.FirstOrDefaultAsync(u => u.ChatId == message.Chat.Id);
